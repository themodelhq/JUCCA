...
from .models import User, BlacklistedKeyword, RestrictedBrand, ProhibitedProduct, ChatHistory
from .schemas import ChatRequest, ChatResponse, UserCreate, UserLogin, PolicyStats
...
async def reset_users(db: Session = Depends(get_db)):
    """Reset/Create default admin and seller users."""
    from .services.auth_service import get_password_hash
