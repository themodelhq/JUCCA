...
class LLMConfig:
    ...
    # Model settings
    MODEL_NAME = os.getenv("GPT4ALL_MODEL", "mistral-7b-openorca.gguf")
...
class GPT4AllManager:
    ...
    def _load_model(self, model_name: str = None):
        ...
        target_model = model_name or LLMConfig.MODEL_NAME
        
        try:
            logger.info(f"Loading GPT4All model: {target_model}")
